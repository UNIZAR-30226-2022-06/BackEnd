...
urlpatterns = [
    ...
    path('Configuraciones', ConfiguracionList.as_view(), name='list-Configuraciones'),
    path('Configuraciones/<int:pk>/', ConfiguracionDetail.as_view(), name='retrieve-Configuracion'),
